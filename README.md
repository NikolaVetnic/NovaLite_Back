# NovaLite Internship Project, Backend
...
NovaLite Internship Project, Social Network Backend. Click the image for video demonstration of the project.
...
```
cd existing_repo
git remote add origin http://git.novalite.rs/vmi/praksa-nikolavetnic-backend.git
git branch -M main
...
- [ ] [Set up project integrations](http://git.novalite.rs/vmi/praksa-nikolavetnic-backend/-/settings/integrations)
